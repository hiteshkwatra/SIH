...
class ddestimator:
	...
	def draw_eye_lines(self, frame, points, ear_R, ear_L):
		...
		cv2.drawContours(frame, [leftEyeHull], -1, (189, 239, 91), 1) 
		cv2.drawContours(frame, [rightEyeHull], -1, (189, 239, 91), 1)
	...
	def get_eye_closedness_over_time(self, ts_threshold=1000, ear_threshold=0.2):
		...
		if count > round(ts_threshold/200):
			...
			return ret, count, np.float32([mx, avg]), closed
	...
	def draw_mouth(self, frame, points, mar):
		...
		cv2.drawContours(frame, [mouthHull],-1, (179, 214, 19), 1)
